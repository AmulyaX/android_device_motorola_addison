...
# SHIMS
TARGET_LD_SHIM_LIBS := /system/bin/adspd|libshim_adsp.so:/system/lib64/libandroid.so|libshim_ril.so:/system/vendor/lib64/libizat_core.so|libshims_get_process_name.so
